...
function JaBody() {
  return (
    <>
      ...
      <h2>受け付けている内容</h2>
      <ul>
        <li><strong>情報の訂正・削除依頼</strong> — 公演日程、アーティスト情報、投稿・コメントなど誤った情報や削除が必要な内容</li>
        <li><strong>著作権・権利関連</strong> — アーティスト名・画像・商標等について権利者様からの修正・削除依頼</li>
        <li><strong>個人情報関連</strong> — データの閲覧・削除依頼(詳細はプライバシーポリシーをご参照ください)</li>
        <li><strong>提携・情報提供</strong> — 新規公演・リリース・フェスティバル情報の提供、協業のご提案</li>
      </ul>
