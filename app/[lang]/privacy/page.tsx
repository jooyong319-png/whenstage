...
function KoBody() {
  return (
    <>
      <h1>개인정보처리방침</h1>
      <p>WhenStage(whenstage.com, 이하 &ldquo;서비스&rdquo;)는 이용자의 개인정보를 소중히 다루며 관련 법령을 준수합니다. 본 방침은 서비스가 수집하는 정보와 이용 방식을 설명합니다.</p>
      ...
      <h2>2. 쿠키 및 맞춤 광고</h2>
      <ul>
        <li>서비스는 광고 게재를 위해 <strong>카카오 AdFit</strong>을 사용할 수 있습니다.</li>
        <li>제3자 광고 사업자는 쿠키 및 광고 식별자를 사용해 이전 방문 기록에 기반한 맞춤 광고를 제공할 수 있습니다.</li>
        <li><a href="https://www.aboutads.info" target="_blank" rel="noopener">www.aboutads.info</a>에서 제3자 쿠키를 거부할 수 있습니다.</li>
      </ul>
      ...
      <p>WhenStage(whenstage.com) 이용자는 다음과 같은 방법으로 데이터 삭제를 요청할 수 있습니다.</p>
      <ul>
        ...
        <li><strong>보관될 수 있는 데이터</strong>: 개인을 식별할 수 없는 집계 형태의 조회수 통계는 서비스 운영을 위해 익명으로 보관될 수 있습니다.</li>
...
function EnBody() {
  return (
    <>
      ...
      <ul>
        <li>The Service may use <strong>Kakao AdFit</strong> to display ads.</li>
        <li>Third-party ad providers may use cookies and ad identifiers to serve personalized ads based on your prior visits.</li>
        <li>You can opt out of third-party cookies at <a href="https://www.aboutads.info" target="_blank" rel="noopener">www.aboutads.info</a>.</li>
      </ul>

      <h2>3. Purpose of use</h2>
      <ul>
        <li>Providing and operating service features such as comments and view counts</li>
        <li>Ad delivery and service improvement</li>
      </ul>
      ...
      <ul>
        ...
        <li>Kakao AdFit — ad delivery (if used)</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Data that may be retained</strong>: aggregate, non-identifying view-count statistics may be retained anonymously for service operation.</li>
...
function JaBody() {
  return (
    <>
      ...
      <ul>
        <li><strong>スケジュール/ニュースへのコメント投稿時</strong>: ニックネーム、コメント内容。</li>
      ...
      <ul>
        <li>本サービスは広告配信のため<strong>カカオAdFit</strong>を使用する場合があります。</li>
        <li>第三者広告事業者は、クッキーや広告識別子を用いて過去の訪問履歴に基づくパーソナライズ広告を配信する場合があります。</li>
        <li><a href="https://www.aboutads.info" target="_blank" rel="noopener">www.aboutads.info</a>で第三者クッキーを拒否できます。</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>保管されるデータ</strong>: 個人を特定できない集計形式の閲覧数統計は、サービス運営のため匿名の形で保管される場合があります。</li>
